...
#include "gaudi/duchamp/cross_test.hpp"
...
public:
  ...
  void initScene() {
    ...
    __surf = gaudi::duchamp::cross_test::create();
...
private:
  ...
  gaudi::duchamp::cross_test::ptr __surf;
...
public:
  ...
  App(std::string file) : gg::SimpleApp(1280, 720, 4.0, true, "cross_test_") {
