...
#include "gaudi/duchamp/heat_geodesics_test.hpp"
...
public:
  ...
  void initScene() {
    ...
    __surf = gaudi::duchamp::heat_geodesics_test::create();
...
private:
  gaudi::duchamp::heat_geodesics_test::ptr __surf;
...
public:
  ...
  App(std::string file) : gg::SimpleApp(1280, 720, 4.0) {
