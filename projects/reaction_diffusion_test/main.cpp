...
#include "gaudi/duchamp/reaction_diffusion_test.hpp"
...
public:
  ...
  void initScene() {
    ...
    __surf = gaudi::duchamp::reaction_diffusion_test::create();
...
private:
  ...
  gaudi::duchamp::reaction_diffusion_test::ptr __surf;
...
public:
  ...
  App(std::string file)
      : gg::SimpleApp(1280, 720, 4.0, true, "reaction_diffusion_test") {
