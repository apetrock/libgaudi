...
#include "gaudi/duchamp/shell_walk_test.hpp"
...
public:
  ...
  void initScene() {
    ...
    __surf = gaudi::duchamp::shell_walk_test::create();
  ...
  virtual void onAnimate(int frame) {
    ...
    __surf->step(frame);
    gg::fillBuffer_ref(*__surf->__M, _obj, gg::colorRGB(0.4, 0.4, 0.4, 1.0));
...
private:
  gaudi::duchamp::shell_walk_test::ptr __surf;
