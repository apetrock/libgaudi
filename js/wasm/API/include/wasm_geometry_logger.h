...
private:
  wasm_geometry_logger() {
  }

  wasm_geometry_logger(const wasm_geometry_logger &);
  wasm_geometry_logger &operator=(const wasm_geometry_logger &);

  static wasm_geometry_logger *global_instance;
