#ifndef __GAUDI_DUCHAMP_MODULES_ROD_CONSTRAINTS__
#define __GAUDI_DUCHAMP_MODULES_ROD_CONSTRAINTS__
...
#include "gaudi/hepworth/block/aesthetic/bundles.hpp"
...
// Single-file rod constraints demo: load → force graph → PD solver (+ adapter).
...
public:
  ...
  rod_constraints_solver() {
    ...
    _tangent =
        _graph.create_node<tangent_point_gradient_node>(__R, __Rd, 1.0e-8);
...
#endif // __GAUDI_DUCHAMP_MODULES_ROD_CONSTRAINTS__
