...
public:
  ...
  obj_loader() {}
  ~obj_loader() {}
  asawa::surf<SPACE> &operator()(string s) { return this->loadfile(s); }
...
void write_obj(asawa::surf<SPACE> &obj, string filename) {
  M2_TYPEDEFS;
...
template <typename SPACE>
void write_pbrt(asawa::surf<SPACE> &obj, const char *filename) {
  M2_TYPEDEFS;
