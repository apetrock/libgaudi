...
#define M2_TYPEDEFS                                                            \
  ...
  typedef asawa::edge_line<SPACE> line_type;                                   \
  typedef asawa::edge_line_pair<SPACE> line_pair;                              \
  typedef asawa::face_triangle<SPACE> triangle_type;                           \
  typedef asawa::face_triangle_pair<SPACE> triangle_pair;                      \
                                                                               \
  typedef asawa::surf<SPACE> surf_type;                                        \
  typedef typename asawa::surf<SPACE>::face face_type;                         \
  typedef typename asawa::surf<SPACE>::edge edge_type;                         \
  typedef typename asawa::surf<SPACE>::vertex vertex_type;                     \
  typedef typename asawa::surf<SPACE>::face_vertex face_vertex_type;           \
                                                                               \
