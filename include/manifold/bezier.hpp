...
//#include "al_Functions.hpp" //pull some of that stuff here, and make it work
//with eigen #include "al_Quat.hpp" #include "al_Interpolation.hpp"
#ifndef __BEZIER__
#define __BEZIER__

template <class Tf, class Tv> class slerp_interpolator {
public:
...
template <class Tf, class Tv> class lerp_interpolator {
public:
  virtual inline Tv operator()(Tf t, const Tv &p0, const Tv &p1) {
...
template <int N, typename T> class point_space {
public:
  typedef T double_t;
...
template <int N, typename T> class rotor_space {
public:
  typedef T double_t;
...
template <typename SPACE> class bezier_curve {
public:
  ...
  point_t find_nearest_chord(point_t Pi, point_t *P, double_t &dist,
                             double_t &t) {
