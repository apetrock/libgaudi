...
namespace m2 {
  ...
  class modify{
	...
	gcen += coordinate_type(v->coordinate()[0],
		      v->coordinate()[1],
		      v->coordinate()[2]);
      }
    ...
    void scale_face(face_ptr f1, T scale){
      ...
      while (it) {
	it = fvb != fve;
	Eigen::Matrix<T,3,1> ins = fvb->coordinate()
	  - f1->center();
	ins.normalize();
    ...
    edge_ptr flip_edge(edge_ptr e1){
      ...
      v1->remove_face_vertex(fv10->position_in_vertex());
      v2->remove_face_vertex(fv11->position_in_vertex());
      v3->remove_face_vertex(fv12->position_in_vertex());
      v3->remove_face_vertex(fv20->position_in_vertex());
      v4->remove_face_vertex(fv21->position_in_vertex());
      v1->remove_face_vertex(fv22->position_in_vertex());			
      ...
      e11->other(fv11) = e12->other(fv12); e11->other(fv11)->edge() = e11;
      e21->other(fv21) = e22->other(fv22); e21->other(fv21)->edge() = e21;						
      e12->other(fv12) = fv21t; fv21t->edge() = e12;
      e22->other(fv22) = fv11t; fv11t->edge() = e22;
